                          ...
                          <div className="flex-1 flex flex-col min-h-[12rem]">
                            <div className="flex justify-between items-start">
                              <div className="max-w-[220px]">
                                ...
                                <div className="flex items-center gap-3 text-xs text-gray-500 mt-2">{["XS","S","M","L","XL","Custom"].map(sz => (<button key={sz} onClick={() => updateSize(it.productId, it.size, sz)} className={`text-sm ${it.size===sz ? 'font-semibold text-black border-b-2 border-solid border-black' : 'text-gray-400'}`}>{sz}</button>))}</div>
